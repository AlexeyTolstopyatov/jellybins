    ...
    internal static class BinaryInformation
    {
        ...
        public static string GetInformation(BinaryInformationPrinter informationPrinter) 
        {
            string info = informationPrinter switch
            {
                ...
                BinaryInformationPrinter.Portable => "Формат PE (Portable Executable) — это формат исполняемых файлов всех 32- и 64-разрядных Windows-систем",
        ...
        public static BinaryInformationPrinter DetectType(uint word)
        {
            return word switch
            {
                0x4d5a or 0x5a4d => BinaryInformationPrinter.MarkZbykowski,
                0x4c58 or 0x584c or 0x4c45 or 0x454c => BinaryInformationPrinter.Linear,
                0x454e or 0x4e45 => BinaryInformationPrinter.New,
                0x4550 or 0x5045 => BinaryInformationPrinter.Portable,
                _ => BinaryInformationPrinter.Other
            };
        }
    }
}
