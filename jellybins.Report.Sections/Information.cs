...
public class Information
{
    ...
    /// </summary>
    public static Dictionary<string, string[]> SectionsToStrings(ref NtHeader32 nt)
    {
        return new()
        {
            {
    ...
    public static Dictionary<string, string[]> SectionsToStrings(ref NtHeader64 nt)
    {
        return new()
        {
            {
            ...
            },
            {
                ...
                {
                    $"Разрядность 0х{nt.WinNtOptional.Magic:x}",
                    $"Основная версия сборщика 0x{nt.WinNtOptional.MajorLinkerVersion:x}",
                    $"Дополнительная версия 0x{nt.WinNtOptional.MinorLinkerVersion:x}",
                    $"Размер .code секции 0x{nt.WinNtOptional.SizeOfCode:x}",
                    $"Размер создающихся объектов 0x{nt.WinNtOptional.SizeOfInitializedData:x}",
                    $"Размер уничтожающихся объектов 0x{nt.WinNtOptional.SizeOfUninitializedData:x}",
                    $"Смещение Точки входа 0x{nt.WinNtOptional.AddressOfEntryPoint:x}",
                    $"Смещение .code секции 0x{nt.WinNtOptional.SizeOfCode}",
                    $"Смещение .data секции 0x{nt.WinNtOptional.BaseOfCode:x}",
                    $"Выравнивание секций 0x{nt.WinNtOptional.SectionAlignment:x}",
                    $"Выравнивание файла 0x{nt.WinNtOptional.FileAlignment:x}",
                    $"Основная версия ОС 0x{nt.WinNtOptional.MajorOperatingSystemVersion:x}",
                    $"Дополнительная версия ОС 0x{nt.WinNtOptional.MinorOperatingSystemVersion:x}",
                    $"Основная версия подсистемы 0x{nt.WinNtOptional.MajorSubsystemVersion:x}",
                    $"Дополнительная версия подсистемы 0x{nt.WinNtOptional.MinorSubsystemVersion:x}",
                    $"Версия Win32 0x{nt.WinNtOptional.Win32VersionValue:x}",
                    $"Размер образа 0x{nt.WinNtOptional.SizeOfImage:x}",
                    $"Размер заголовков 0x{nt.WinNtOptional.SizeOfHeaders:x}",
                    $"Контрольная сумма 0x{nt.WinNtOptional.CheckSum:x}",
                    $"Характеристики 0x{nt.WinNtOptional.DllCharacteristics:x}",
                    $"Стэк 0x{nt.WinNtOptional.SizeOfStackReserve:x}",
                    $"Куча {nt.WinNtOptional.SizeOfHeapCommit:x}",
                    $"Размер коммита в стэк 0x{nt.WinNtOptional.SizeOfStackCommit:x}",
                    $"Размер коммита в кучу 0x{nt.WinNtOptional.SizeOfHeapCommit:x}",
                    $"Флаги загрузчика {nt.WinNtOptional.LoaderFlags:x}",
                    $"Количество RVA и Размеры 0x{nt.WinNtOptional.NumberOfRvaAndSizes:x}"
