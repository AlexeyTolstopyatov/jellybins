...
public class NewExecutableStrings : IStrings
{
    ...
    public string SubsystemFromOperatingSystemFlagToString<T>(T word = default(T))
    {
        ...
        return os switch
        {
            0x2 or 0x4 => PortableExecutableSubsystem.Win16Gui.ToString(),
            0x1 => PortableExecutableSubsystem.Os2SsCui.ToString(),
            _ => PortableExecutableSubsystem.NtVirtualDosMachine.ToString()
        };
    }
