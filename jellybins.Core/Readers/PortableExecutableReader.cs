...
public class PortableExecutableReader : IReader
{
    ...
    public PortableExecutableReader(PortableExecutable32 head32)
    {
        _head32 = head32;
        _head64 = new();
    ...
    public PortableExecutableReader(PortableExecutable64 head64)
    {
        _head32 = new();
        _head64 = head64;
        _strings = new PortableExecutableStrings();
    ...
    public Dictionary<string, string[]> GetFlags()
    {
        ...
        {
            ((characteristics & 0x0001) != 0) ? "HIGH_ENTROPY_VA" : "",
            ((characteristics & 0x0020) != 0) ? "DYNAMIC_BASE" : "",
            ((characteristics & 0x0040) != 0) ? "FORCE_INTEGRITY" : "",
            ((characteristics & 0x0080) != 0) ? "NX_COMPAT" : "",
            ((characteristics & 0x0100) != 0) ? "NO_ISOLATION" : "",
            ((characteristics & 0x0200) != 0) ? "NO_SEH" : "",
            ((characteristics & 0x0400) != 0) ? "NO_BIND" : "",
            ((characteristics & 0x0800) != 0) ? "APPCONTAINER" : "",
            ((characteristics & 0x1000) != 0) ? "WDM_DRIVER" : "",
            ((characteristics & 0x2000) != 0) ? "GUARD_CF" : "",
            ((characteristics & 0x4000) != 0) ? "TERMINAL_SERVER_AWARE" : "",
        }
