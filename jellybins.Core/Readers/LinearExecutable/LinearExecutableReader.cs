...
public class LinearExecutableReader : IReader
{
    ...
    public Dictionary<string, string[]> GetFlags()
    {
        var iterates = from item in new[] {
            (_head.ModuleTypeFlags & 0x00000000) != 0 ? "Executable Module" : "",
            (_head.ModuleTypeFlags & 0x00008000) != 0 ? "Library Module" : "",
            (_head.ModuleTypeFlags & 0x00000004) != 0 ? "PerProcess Init" : "Standard Init",
            (_head.ModuleTypeFlags & 0x00000010) != 0 ? "Internal Fixes" : "",
            (_head.ModuleTypeFlags & 0x00000020) != 0 ? "External Fixes" : "",
            (_head.ModuleTypeFlags & 0x00000100) != 0 ? "OS/2 PM Incompatible" : "",
            (_head.ModuleTypeFlags & 0x00000200) != 0 ? "OS/2 PM Compatible" : "",
            (_head.ModuleTypeFlags & 0x00000300) != 0 ? "OS/2 PM Required" : "",
            (_head.ModuleTypeFlags & 0x00002000) != 0 ? "Not loads" : "Loads",
            (_head.ModuleTypeFlags & 0x00020000) != 0 ? "Physical Driver" : "",
            (_head.ModuleTypeFlags & 0x00028000) != 0 ? "Virtual Driver" : "",
            (_head.ModuleTypeFlags & 0x00040000) != 0 ? "PerProcess Term" : "",
            (_head.ModuleTypeFlags & 0x00080000) != 0 ? "MultiCPU Unsafe" : ""
        }
