...
{
    [MarshalAs(UnmanagedType.ByValArray, SizeConst = 16)] public byte[] e_ident; // ELF magic number (16 bytes)
    [MarshalAs(UnmanagedType.U2)] public ushort e_type;    // Object file type
    [MarshalAs(UnmanagedType.U2)] public ushort e_machine; // CpuArchitecture
    public uint e_version;  // ELF file version
    public uint e_entry;    // Entry point address
    public uint e_phoff;    // Program header table file offset
    public uint e_shoff;    // PortableExecutableDataSection header table file offset
    public uint e_flags;    // Processor-specific flags
    [MarshalAs(UnmanagedType.Struct)] public ElfData e_ehsize;  // ELF header size
    [MarshalAs(UnmanagedType.Struct)] public ElfData e_phentsize; // Program header entry size
    [MarshalAs(UnmanagedType.Struct)] public ElfData e_phnum;    // Number of program headers
    [MarshalAs(UnmanagedType.Struct)] public ElfData e_shentsize; // PortableExecutableDataSection header entry size
    [MarshalAs(UnmanagedType.Struct)] public ElfData e_shnum;    // Number of section headers
    [MarshalAs(UnmanagedType.Struct)] public ElfData e_shstrndx; // PortableExecutableDataSection header string table index
}
...
{
    [MarshalAs(UnmanagedType.ByValArray, SizeConst = 16)] public byte[] e_ident; // ELF magic number (16 bytes)
    [MarshalAs(UnmanagedType.Struct)] public ElfData e_type;    // Object file type
    [MarshalAs(UnmanagedType.Struct)] public ElfData e_machine; // CpuArchitecture
    public uint e_version;  // ELF file version
    public ulong e_entry;    // Entry point address
    public ulong e_phoff;    // Program header table file offset
    public ulong e_shoff;    // PortableExecutableDataSection header table file offset
    public uint e_flags;    // Processor-specific flags
    [MarshalAs(UnmanagedType.Struct)] public ElfData e_ehsize;  // ELF header size
    [MarshalAs(UnmanagedType.Struct)] public ElfData e_phentsize; // Program header entry size
    [MarshalAs(UnmanagedType.Struct)] public ElfData e_phnum;    // Number of program headers
