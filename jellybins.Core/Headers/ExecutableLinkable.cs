...
public struct ExecutableLinkable32
{
    ...
    [MarshalAs(UnmanagedType.Struct)] public ElfData e_shentsize; // Section header entry size
    [MarshalAs(UnmanagedType.Struct)] public ElfData e_shnum;    // Number of section headers
    [MarshalAs(UnmanagedType.Struct)] public ElfData e_shstrndx; // Section header string table index
}
